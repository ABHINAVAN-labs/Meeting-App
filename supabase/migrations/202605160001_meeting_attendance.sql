...
create index if not exists idx_meeting_attendance_records_meeting on public.meeting_attendance_records(meeting_code);

drop trigger if exists trg_meeting_attendance_records_touch_updated_at on public.meeting_attendance_records;
