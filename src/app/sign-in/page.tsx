      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="mt-8 space-y-4">
          <button
            ...
            className="w-full flex items-center justify-center px-4 py-3 border border-zinc-800 rounded-lg text-white hover:bg-zinc-900 transition-colors"
          >
        ...
        <form onSubmit={handleSignIn} className="mt-8 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-3 py-2 bg-zinc-900 border border-zinc-800 rounded text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-800 disabled:cursor-not-allowed text-white font-medium rounded transition-colors"
          >
